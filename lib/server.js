...
var startBusServices = function (err) {
  ...
  commander.registerAutoconnectHandler (function (msg) {
    ...
    var connectedMsg = {
      ...
      orcName:          orcName,
      autoConnectToken: msg.data,
      cmdRegistry:      registry
    };

    boot.busClient.events.send ('greathall::autoconnect.finished', connectedMsg);
    boot.busClient.events.send (orcName +'::motd', generateMotd ());
  });
